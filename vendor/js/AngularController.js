function formulario(){
	var email = logar.email.value;
	var password = logar.password.value;
...
meuSite.controller('meuController', function($scope, $http){
    ...
    data = new Date();
    var baseUrl = 'http://atualgeek.com/francoDevCI/';
    $scope.msg = "";
    ...
    $scope.otherProjects = [
        ...
        {src: baseUrl + "vendor/img/Particip_sites/casamentopratico.jpg", url: "http://casamentopratico.com.br", nome: "Casamento PrÃ¡tico"},
